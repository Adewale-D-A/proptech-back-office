...
export const dailyOccupancy = createSlice({
  ...
  reducers: {
    updateDailyOccupancyList: (state, action) => {
      state.value.status = true;
      state.value.data = action?.payload?.data;
    },
    addDailyOccupancyToList: (state, action) => {
    ...
    removeDailyOccupancyInList: (state, action) => {
    ...
    replaceDailyOccupancyInList: (state, action) => {
      const { id } = action?.payload;
      const currentArray = state.value.data;
      const currentIndex = currentArray.findIndex(
        (v: { id: number }) => String(v.id) === String(id)
...
export const {
  updateDailyOccupancyList,
  addDailyOccupancyToList,
  addToPaginationHistory,
  removeDailyOccupancyInList,
  replaceDailyOccupancyInList,
  clearDailyOccupancyList,
} = dailyOccupancy.actions;

export default dailyOccupancy.reducer;
