...
export const upcomingReservation = createSlice({
  ...
  reducers: {
    updateUpcomingReservationList: (state, action) => {
      state.value.status = true;
      state.value.data = action?.payload?.data;
    },
    addUpcomingReservationToList: (state, action) => {
    ...
    removeUpcomingReservationInList: (state, action) => {
    ...
    replaceUpcomingReservationInList: (state, action) => {
      const { id } = action?.payload;
      const currentArray = state.value.data;
      const currentIndex = currentArray.findIndex(
        (v: { id: number }) => String(v.id) === String(id)
    ...
    clearUpcomingReservationList: (state) => {
...
export const {
  ...
  addUpcomingReservationToList,
  addToPaginationHistory,
  removeUpcomingReservationInList,
  replaceUpcomingReservationInList,
  clearUpcomingReservationList,
} = upcomingReservation.actions;

export default upcomingReservation.reducer;
