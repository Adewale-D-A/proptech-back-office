...
export const arrivingReservation = createSlice({
  ...
  reducers: {
    updateArrivingReservationList: (state, action) => {
      state.value.status = true;
      state.value.data = action?.payload?.data;
    },
    addArrivingReservationToList: (state, action) => {
    ...
    removeArrivingReservationInList: (state, action) => {
    ...
    replaceArrivingReservationInList: (state, action) => {
      const { id } = action?.payload;
      const currentArray = state.value.data;
      const currentIndex = currentArray.findIndex(
        (v: { id: number }) => String(v.id) === String(id)
    ...
    clearArrivingReservationList: (state) => {
...
export const {
  ...
  addArrivingReservationToList,
  addToPaginationHistory,
  removeArrivingReservationInList,
  replaceArrivingReservationInList,
  clearArrivingReservationList,
} = arrivingReservation.actions;

export default arrivingReservation.reducer;
