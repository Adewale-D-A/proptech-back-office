...
export const houseRulesData = createSlice({
  name: "house rules",
  initialState: {
    value: {
      status: false,
...
export const {
  ...
  replaceHouseRule,
  clearHouseRules,
} = houseRulesData.actions;

export default houseRulesData.reducer;
