    ...
    <div className="w-full rounded-2xl border p-3 flex flex-col md:flex-row gap-3 md:items-center justify-between">
      <div className=" flex flex-col gap-2">
        <div className=" flex items-center gap-2">
          ...
          <h5 className=" font-semibold text-lg">Vitoria heights</h5>
        </div>
        ...
        <div className="text-gray-400 flex items-center gap-1">
          ...
          <span className=" text-sm ">Fri, 04 Oct 2024</span>
        </div>
        <div className="text-gray-400 flex items-center gap-1">
          <CalendarIcon className=" size-4" />
          <span className=" text-sm ">Sat, 09 Oct 2024</span>
        </div>
      </div>
      <div className=" flex flex-col gap-2">
        <div className=" flex items-center gap-2">
          <SplitArrowIcon className=" text-primary size-4 rotate-45" />
          <h5 className=" font-semibold text-lg">SunCity heights</h5>
        </div>
        <div className="text-gray-400 flex items-center gap-1">
          <MoonIcon className=" size-4" />
